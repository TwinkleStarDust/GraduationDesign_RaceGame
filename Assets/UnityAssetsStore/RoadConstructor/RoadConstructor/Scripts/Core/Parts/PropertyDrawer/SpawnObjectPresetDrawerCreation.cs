...
namespace PampelGames.RoadConstructor
{
    public static class SpawnObjectPresetDrawerCreation
    {
        ...
        private static VisualElement MakeObjectClassItem()
        {
            ...
            item.Add(objectType);
            item.Add(obj);
            item.Add(spacingWrapper);
            item.Add(position);
            item.Add(positionOffsetForward);
            item.Add(positionOffsetRight);
            item.Add(heightOffset);
            item.Add(rotation);
            item.Add(alignToNormal);
            item.Add(scale);
            item.Add(requiresDirectionWrapper);
            item.Add(elevation);
            item.Add(heightRange);
            item.Add(removeOverlap);
            item.Add(chance);
