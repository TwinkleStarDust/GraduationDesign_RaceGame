...
namespace PampelGames.RoadConstructor
{
    public static class RoadDrawerCreation
    {
        public static VisualElement CreatePropertyGUI(Road _road, SerializedProperty property)
        {
            ...
            splineEdgesListView.style.marginTop = 6;
            ...
            trafficLanesListView.tooltip = "Traffic lanes operate independently from construction and can be optionally utilized for custom traffic systems. " +
