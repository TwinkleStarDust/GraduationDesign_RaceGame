...
{
    [BurstCompile]
    internal static class SplineWorldUtility
    {
        ...
        private struct SplinePositionsJob : IJob
        {
            ...
            public void Execute()
            {
                ...
                _splineLeft.Evaluate(1f, out var pos1, out var tan1, out var upVector1);
        ...
        private struct CheckPositionsInsideSplineJob : IJob
        {
            ...
            public void Execute()
            {
                for (var i = 0; i < _positions.Length; i++) 
                {
                    ...
                    SplineUtility.GetNearestPoint(_spline, pos, out var nearest, out var t);
