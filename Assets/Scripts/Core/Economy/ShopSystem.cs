...
{
    #region 单例实现
    private static ShopSystem s_Instance;
    ...
    { 
        get 
        {
            if (s_Instance == null)
            {
                GameObject managerObj = GameObject.Find("ShopSystem");
                if (managerObj == null)
                {
                    managerObj = new GameObject("ShopSystem");
                    s_Instance = managerObj.AddComponent<ShopSystem>();
                }
                else
                {
                    s_Instance = managerObj.GetComponent<ShopSystem>();
                    if (s_Instance == null)
                    {
                        s_Instance = managerObj.AddComponent<ShopSystem>();
                    }
